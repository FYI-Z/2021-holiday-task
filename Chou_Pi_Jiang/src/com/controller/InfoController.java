...
import com.service.serviceImp.ServiceInfoImp;
...
public class InfoController extends HttpServlet {
	...
	private void ModifyUser(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			permission = Integer.parseInt(request.getParameter("permission"));
			System.out.println("����������"+password+"name: "+name+"sex: "+sex+"age: "+age+"position: "+position+"department: "+department+"contact:"+contact+"permission "+permission);
